...
- 2026-05-13: 功能地图新增 BLE MIDI 行；生成物表新增 AVP Take 录制；推荐阅读提及 BLE MIDI 数据流。
- 2026-05-14: 同步 AVP 左右手与双谱表五线谱能力：导入阶段补 staff、`ScoreHand` 贯穿 step/guide/高亮/判定；练习页五线谱迁移为 grand staff；测试命令更新为 concrete destination id。
