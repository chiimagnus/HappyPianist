...
private extension View {
    func libraryPracticeCardSurface(cornerRadius: CGFloat) -> some View {
        modifier(LibraryPracticeCardSurfaceModifier(cornerRadius: cornerRadius))
    }
}

private extension SongPracticeLibraryOverviewStatus {
    var title: String {
        switch self {
        case .learning: "正在学习"
        case .stable: "进展稳定"
...
private extension SongPracticeMeasureProgressState {
    var stableMeasureCount: Int {
        switch self {
...
private extension SongPracticeFocusReason {
    var libraryDisplayName: String {
        switch self {
    ...
    private enum LibraryPracticePreviewFixture {
        ...
        static let overview = SongPracticeLibraryOverview(
            ...
            sessionSummary: SongPracticeSessionSummary(
                latestPracticeEndedAt: .now.addingTimeInterval(-86400),
        ...
        static let metadataUnavailableOverview = SongPracticeLibraryOverview(
            ...
            sessionSummary: SongPracticeSessionSummary(
                ...
                totalActiveDurationMilliseconds: 45000,
                sessionCount: 1,
                streak: nil
            ),
