...
enum DuetPhrasePolicy {
    ...
    static func requestPolicy(for decision: CompanionDecision) -> RequestPolicy {
        RequestPolicy(
            lookbackSeconds: 4.0,
    ...
    private static func adjustedVelocity(_ velocity: UInt8, mode: CompanionParticipationMode) -> UInt8 {
        switch mode {
        case .support:
