...
public struct MusicXMLOrnamentScheduleResult: Equatable {
    public let generatedNotes: [ScoreGeneratedNoteEvent]
    public let resolutions: [ScorePerformanceNotationResolution]
}

public struct MusicXMLOrnamentScheduler {
