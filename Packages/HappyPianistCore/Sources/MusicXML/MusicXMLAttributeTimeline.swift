...
public struct MusicXMLAttributeTimeline: Equatable {
    ...
    public func meter(atTick tick: Int, partID: String? = nil, staffNumber: Int? = nil) -> MusicXMLMeter? {
        timeSignature(atTick: tick, partID: partID, staffNumber: staffNumber)?.meter
    }

    public func keySignature(
        atTick tick: Int,
        partID: String? = nil,
        staffNumber: Int? = nil
    ...
    public func clef(atTick tick: Int, partID: String? = nil, staffNumber: Int) -> MusicXMLClefEvent? {
