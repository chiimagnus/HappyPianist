...
public enum MusicXMLTimewiseConverterError: Error, Equatable {
    case invalidXML
    case unsupportedRootElement
}

public struct MusicXMLTimewiseConverter {
    public func convertToPartwiseIfNeeded(data: Data) throws -> Data {
