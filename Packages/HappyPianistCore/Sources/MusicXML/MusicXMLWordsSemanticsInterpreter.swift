...
public enum MusicXMLTempoWordKind: String, Equatable {
    case ritardando
    case rallentando
    case accelerando
    case stringendo
...
public enum MusicXMLTempoWordResolution: Equatable {
    case tempoRamp
    case tempoEvent
...
public struct MusicXMLTempoWordAnnotation: Equatable {
    ...
    public let kind: MusicXMLTempoWordKind
    public let resolution: MusicXMLTempoWordResolution
...
public struct MusicXMLWordsSemanticsResult: Equatable {
    public let derivedTempoEvents: [MusicXMLTempoEvent]
    public let derivedTempoRamps: [MusicXMLTempoMap.TempoRamp]
    public let derivedPedalEvents: [MusicXMLPedalEvent]
    public let tempoAnnotations: [MusicXMLTempoWordAnnotation]
}
