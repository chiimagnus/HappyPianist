...
public struct MusicXMLTempoMap: Sendable {
    ...
    public init(tempoEvents: [MusicXMLTempoEvent], defaultQuarterBPM: Double = 120) {
        self.init(
    ...
    public init(tempoEvents: [MusicXMLTempoEvent], tempoRamps: [TempoRamp], defaultQuarterBPM: Double = 120) {
        self.init(
            tempoEvents: tempoEvents,
    ...
    public init(performanceEvents: [ScorePerformanceTempoEvent], defaultQuarterBPM: Double = 120) {
    ...
    public func performanceEvents() -> [PerformanceEvent] {
    ...
    public func quarterBPM(atTick tick: Int) -> Double {
        let clampedTick = max(0, tick)
    ...
    public func durationSeconds(fromTick: Int, toTick: Int) -> TimeInterval {
