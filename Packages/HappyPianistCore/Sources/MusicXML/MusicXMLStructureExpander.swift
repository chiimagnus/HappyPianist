...
public struct MusicXMLStructureExpander {
    private let maxOutputMeasures: Int
    private let maxJumps: Int

    public init(maxOutputMeasures: Int = 10000, maxJumps: Int = 64) {
        self.maxOutputMeasures = max(0, maxOutputMeasures)
        self.maxJumps = max(0, maxJumps)
    }

    public func expandStructureIfPossible(
        score: MusicXMLScore,
    ...
    public func expandRepeatAndEndingIfPossible(
        score: MusicXMLScore,
        primaryPartID: String = "P1",
        includedPartIDs: Set<String>? = nil
    ) -> MusicXMLScore {
...
extension MusicXMLStructureExpander {
    ...
    public func expandSoundJumpsIfPossible(
        score: MusicXMLScore,
        primaryPartID: String = "P1",
        includedPartIDs: Set<String>? = nil
    ) -> MusicXMLStructureExpansionResult {
