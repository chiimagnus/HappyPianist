...
public struct PerformanceAlignmentConfiguration: Equatable, Sendable {
    public let candidateWindowSeconds: TimeInterval
    public let ambiguityCostTolerance: Double
    public let pitchMismatchCost: Double
    public let onsetWeight: Double
    public let chordSpreadWeight: Double
    public let unmatchedCost: Double
...
public struct PerformanceAlignmentEngine: Sendable {
    ...
    public var candidateWindowSeconds: TimeInterval {
        configuration.candidateWindowSeconds
    }

    public init(configuration: PerformanceAlignmentConfiguration = .init()) {
        self.configuration = configuration
    }

    public func performanceSeconds(plan: ScorePerformancePlan, atTick tick: Int) -> TimeInterval {
