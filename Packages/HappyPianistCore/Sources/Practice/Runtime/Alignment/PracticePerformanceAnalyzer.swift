...
public struct PracticePerformanceAnalyzerSnapshot: Equatable, Sendable {
    public let roundGeneration: UInt64
    let alignment: PerformanceAlignment?
    public let assessment: PassagePerformanceAssessment?
    public let acceptedObservationCount: Int
    public let rejectedObservationCount: Int
    public let discardedObservationCount: Int
    public let alignmentLatencyMilliseconds: Int64?
    public let isRunning: Bool
}

public actor PracticePerformanceAnalyzer {
    ...
    public init(diagnosticsReporter: (any DiagnosticsReporting)? = nil) {
        ...
        assessmentService = PerformanceAssessmentService()
    }
    ...
    public func beginRound(at start: PerformanceMonotonicInstant) {
        roundGeneration += 1
        roundStart = start
    ...
    public func registerInputCapabilities(_ capabilities: PerformanceInputCapabilities) {
        inputCapabilities = inputCapabilities.merging(capabilities)
        updateAssessment()
    }

    public func finishRound() async -> PracticePerformanceAnalyzerSnapshot {
    ...
    public func snapshot() -> PracticePerformanceAnalyzerSnapshot {
