...
public struct IncrementalPerformanceAligner {
    ...
    public struct Configuration: Equatable {
        public let maximumBufferedObservations: Int
        public let commitHorizonSeconds: TimeInterval

        public init(maximumBufferedObservations: Int = 4096, commitHorizonSeconds: TimeInterval = 0.3) {
    ...
    public mutating func finish() -> PerformanceAlignment? {
