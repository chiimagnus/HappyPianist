...
public enum PracticeSessionFact: Equatable, Sendable {
...
public struct PracticeAttemptReductionState: Equatable, Sendable {
    public var failedStepIndices: Set<Int> = []
    public var failedOccurrences: Set<PracticeMeasureOccurrenceID> = []
    public var matchedStepIndicesByOccurrence: [PracticeMeasureOccurrenceID: Set<Int>] = [:]

    public init() {}
}

public struct PracticeAttemptReducer {
    public struct Result: Equatable, Sendable {
        public let progress: SongPracticeProgress
        public let reductionState: PracticeAttemptReductionState
        public let fact: PracticeSessionFact?
    }

    public init() {}

    public func reduceAttempt(
    ...
    public func reducePassageRestart(
        progress: SongPracticeProgress?,
        identity: PracticeSongIdentity,
        configuration: PracticeRoundConfiguration,
        timestamp: Date
    ...
    public func reducePassageCompletion(
        progress: SongPracticeProgress?,
        reductionState: PracticeAttemptReductionState,
        identity: PracticeSongIdentity,
        configuration: PracticeRoundConfiguration,
    ...
    public func reducePerformanceAssessment(
        progress: SongPracticeProgress,
        identity: PracticeSongIdentity,
        configuration: PracticeRoundConfiguration,
        timestamp: Date,
