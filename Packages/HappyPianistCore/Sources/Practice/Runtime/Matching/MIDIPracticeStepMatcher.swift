...
@MainActor
public protocol MIDIPracticeStepMatchingProtocol: AnyObject {
...
@MainActor
public final class MIDIPracticeStepMatcher: MIDIPracticeStepMatchingProtocol {
    public struct Configuration: Equatable, Sendable {
        var simultaneousOnsetSpread: TimeInterval = 0.08
        var rolledOnsetSpan: TimeInterval = 0.55

        public init(
            simultaneousOnsetSpread: TimeInterval = 0.08,
            rolledOnsetSpan: TimeInterval = 0.55
        ) {
            self.simultaneousOnsetSpread = simultaneousOnsetSpread
            self.rolledOnsetSpan = rolledOnsetSpan
        }
    }
    ...
    public func reset(stepIndex: Int, expectedNotes: [PracticeStepNote]) {
    ...
    public func register(_ observation: PerformanceObservation) -> StepAttemptMatchResult? {
