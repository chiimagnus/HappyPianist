...
public struct HandSeparatedNoteEvidence: Equatable, Sendable {
    public let right: Set<Int>
    public let left: Set<Int>
    public let hasUncertainCandidate: Bool

    public var all: Set<Int> {
        right.union(left)
    }
    ...
    public init(right: Set<Int> = [], left: Set<Int> = [], hasUncertainCandidate: Bool = false) {
        self.right = right
        self.left = left
...
public protocol ChordAttemptAccumulatorProtocol: AnyObject {
    func register(
...
public extension ChordAttemptAccumulatorProtocol {
    func registerHandSeparated(
        evidence: HandSeparatedNoteEvidence,
        expectedRightNotes: [Int],
        expectedLeftNotes: [Int],
...
public final class ChordAttemptAccumulator: ChordAttemptAccumulatorProtocol {
    ...
    public func registerHandSeparated(
        evidence: HandSeparatedNoteEvidence,
        expectedRightNotes: [Int],
        expectedLeftNotes: [Int],
        expectedUnassignedNotes: [Int],
