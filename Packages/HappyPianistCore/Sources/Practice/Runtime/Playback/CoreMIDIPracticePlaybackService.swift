...
@MainActor
public final class CoreMIDIPracticePlaybackService: PracticeSequencerPlaybackServiceProtocol {
    ...
    public func stop(resetCommands: [PerformanceTransportCommand]) async {
        await haltPlayback()
        execute(resetCommands)
    }

    public func load(sequence: PracticeSequencerSequence) async throws {
        try ensureReady()
        await haltPlayback()
    ...
    public func play(fromSeconds start: TimeInterval) async throws {
        try ensureReady()
    ...
    public func playOneShot(commands: [PracticePlaybackCommand], durationSeconds: TimeInterval) async throws {
    ...
    public func execute(commands: [PracticePlaybackCommand]) async throws {
        try ensureReady()
        try execute(commands: commands, tracking: .live)
    }

    public func stopAllLiveNotes() async {
