...
public struct PracticeSequencerMIDIEvent: Equatable, Sendable {
...
public enum PracticeSequencerSequenceBuilderError: LocalizedError, Equatable, Sendable {
...
public struct PracticeSequencerSequenceBuilder {
    ...
    public func buildPerformanceEventSchedule(
