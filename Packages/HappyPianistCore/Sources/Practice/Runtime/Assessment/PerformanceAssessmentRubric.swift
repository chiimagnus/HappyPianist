...
public struct PerformanceAssessmentRubric {
    public let version = PerformanceAssessmentRubricVersion.capabilityAware
    private let targetProfile: PerformanceTargetProfile

    public init(targetProfile: PerformanceTargetProfile = PerformanceTargetProfile()) {
        self.targetProfile = targetProfile
    }

    public func acceptableBands(
    ...
    public func usesGenericTarget(for dimension: PerformanceAssessmentDimension) -> Bool {
