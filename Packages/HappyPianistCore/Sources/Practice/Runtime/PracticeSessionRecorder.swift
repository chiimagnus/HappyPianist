...
public struct PracticeSessionRecorderClock: Sendable {
    public let monotonic: PerformanceClock
    public let wallDate: @Sendable () -> Date
    public let localDay: @Sendable (Date) -> PracticeLocalDay?

    public init(
        monotonic: PerformanceClock,
        wallDate: @escaping @Sendable () -> Date,
        localDay: @escaping @Sendable (Date) -> PracticeLocalDay?
    ) {
...
public enum PracticeSessionRecorderSaveStatus: Equatable, Sendable {
    case idle
    case pending
    case saved
    case failed(description: String)

    public var permitsExit: Bool {
        switch self {
        case .idle, .saved:
            true
        case .pending, .failed:
...
public actor PracticeSessionRecorder {
    ...
    @discardableResult
    public func bindIdentity(_ identity: PracticeSongIdentity) -> PracticeSessionRecorderSaveStatus {
    ...
    @discardableResult
    public func setSceneActive(_ isActive: Bool) async -> PracticeSessionRecorderSaveStatus {
        guard var visit, visit.isFinalized == false else { return saveStatus }
    ...
    @discardableResult
    public func setGuiding(_ isGuiding: Bool) async -> PracticeSessionRecorderSaveStatus {
        guard var visit, visit.isFinalized == false else { return saveStatus }
    ...
    @discardableResult
    public func setSettingsPresented(_ isPresented: Bool) async -> PracticeSessionRecorderSaveStatus {
        guard var visit, visit.isFinalized == false else { return saveStatus }
    ...
    @discardableResult
    public func checkpoint() async -> PracticeSessionRecorderSaveStatus {
        guard var visit, visit.isFinalized == false else { return saveStatus }
        advance(&visit)
        self.visit = visit
        queueCurrentRecord()
    ...
    @discardableResult
    public func finalize() async -> PracticeSessionRecorderSaveStatus {
    ...
    public func discardPendingDelta() async {
        cancelPeriodicCheckpoint()
    ...
    public func record(_ observation: PerformanceObservation) async {
    ...
    public func registerInputCapabilities(_ capabilities: PerformanceInputCapabilities) async {
    ...
    public func resetAnalysis() async {
        await performanceAnalyzer.reset()
    }

    public func analysisSnapshot() async -> PracticePerformanceAnalyzerSnapshot {
