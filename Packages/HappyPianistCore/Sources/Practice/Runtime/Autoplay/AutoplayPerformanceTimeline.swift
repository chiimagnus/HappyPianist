...
public struct AutoplayPerformanceTimeline: Equatable, Sendable {
    ...
    public struct Event: Equatable, Identifiable, Sendable {
        ...
        public init(id: Int, sourceEventID: String? = nil, tick: Int, kind: EventKind) {
            self.id = id
    ...
    public func firstEventIndex(atOrAfter tick: Int) -> Int {
        var low = 0
    ...
    @MainActor
    public static func buildOffMain(
        plan: ScorePerformancePlan,
        guideProjection: [PianoHighlightGuide],
        stepProjection: [PracticeStep],
        tempoMap: MusicXMLTempoMap,
    ...
    private static func build(input: BuildInput) -> AutoplayPerformanceTimeline {
        ...
        // Priority 0 lets the sole fermata pause hold same-tick note-offs without changing plan note ticks.
...
public extension AutoplayPerformanceTimeline {
