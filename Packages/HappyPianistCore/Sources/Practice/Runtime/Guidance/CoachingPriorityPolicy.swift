...
public struct CoachingDecisionSignature: Equatable, Hashable {
    public let actionKind: CoachingActionKind
    public let scoreRange: Range<Int>

    public init(_ decision: CoachingDecision) {
        actionKind = decision.action.kind
        scoreRange = decision.action.scoreRange
    }
}

public struct CoachingPriorityContext: Equatable {
    public let skippedDecisions: Set<CoachingDecisionSignature>
    public let previousDecision: CoachingDecision?
    public let consecutiveUnimprovedAssessments: Int
...
public struct CoachingPriorityPolicy {
