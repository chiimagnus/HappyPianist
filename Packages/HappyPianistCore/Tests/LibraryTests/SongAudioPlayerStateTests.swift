...
@MainActor
struct SongAudioPlayerStateTests {
    @Test func playbackControllerTogglesPlayAndPauseForSameEntry() throws {
    ...
    @Test func playbackControllerStopsPreviousSongWhenSwitchingEntries() throws {
        let player = FakeSongAudioPlayer()
        let controller = SongAudioPlaybackStateController(player: player)
    ...
    @Test func playbackControllerClampsSeekProgressToDuration() throws {
        let player = FakeSongAudioPlayer()
    ...
    @Test func playbackControllerClearsStateWhenPlaybackFinishes() throws {
        let player = FakeSongAudioPlayer()
        let controller = SongAudioPlaybackStateController(player: player)
